...
- Complex data table, tree view, calendar/date picker, charts, command menu, side navigation, breadcrumbs, rich text, file upload, and advanced combobox/multiselect.
- These require a separate discovery, plan, and approval cycle.
