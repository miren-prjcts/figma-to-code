 ...
 * `vitest/globals` via its `types` array — see DSV2-014). This local declaration covers just
 * the surface this package actually uses: `axe(container)` and `expect(...).toHaveNoViolations()`.
 *
